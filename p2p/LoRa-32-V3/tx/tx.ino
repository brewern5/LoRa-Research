...
static const uint8_t DEMO_AUDIO[512] = {0};
...
void loop()
{
    ...
    uint16_t total_frags = (DEMO_AUDIO_LEN + LORA_MAX_DATA_PAYLOAD - 1) / LORA_MAX_DATA_PAYLOAD;
    ...
    if (!lora.sendAudioStart(total_frags, 0x00, 8000, 64, DEMO_AUDIO_LEN))
    {
